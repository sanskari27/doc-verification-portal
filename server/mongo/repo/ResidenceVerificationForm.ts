...
const NeighbourhoodObservationsSchema =
  new mongoose.Schema<NeighbourhoodObservations>(
    {
...
const ResidenceVerificationFormSchema =
  new mongoose.Schema<IResidenceVerificationForm>({
    task_id: {
