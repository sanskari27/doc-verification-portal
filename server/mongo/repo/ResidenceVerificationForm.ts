...
export const ResidenceVerificationFormSchema = new Schema({
  ...
  presentVehicle: {
    type: PresentVehicleSchema,
    required: true,
    default: () => ({}),
  },
  financerDetail: {
    type: FinancerDetailSchema,
    required: true,
    default: () => ({}),
  },
  customerCooperation: { type: String, required: true, default: "Polite" },
  neighbourhoodCheck: {
    type: NeighbourhoodCheckSchema,
    required: true,
    default: () => ({}),
  },
  constructionResidence: {
    type: ConstructionResidenceSchema,
    required: true,
    default: () => ({}),
  },
  exteriorsResidence: {
    type: ExteriorsResidenceSchema,
    required: true,
    default: () => ({}),
  },
