...
import { ITeleVerificationForm } from '../types/teleVerificationForm';
...
const TelephoneVerificationSchema = new Schema({
    ...
    residenceRelationWithApplicant: { type: String, required: true, default: 'NA' },
    officeContactNumber: { type: Number, required: true, default: 0 },
    officeContactPerson: { type: String, required: true, default: 'NA' },
    officeRelationWithApplicant: { type: String, required: true, default: 'NA' },
}, { _id: false });
...
const TeleVerificationFormSchema = new mongoose.Schema<ITeleVerificationForm>({
    ...
    applicantSalutation: { type: String, required: true, default: 'Mr./Ms.' },
    ...
    telephoneVerification: { type: TelephoneVerificationSchema, required: true, default: () => ({}) },
    businessDetails: { type: BusinessDetailsSchema, required: true, default: () => ({}) },
    teleCallResidentAttempt1: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallResidentAttempt2: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallResidentAttempt3: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallOfficeAttempt1: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallOfficeAttempt2: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallOfficeAttempt3: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    gaurantorDetails: { type: GaurantorDetailsSchema, required: true, default: () => ({}) },
    detailsOfReference1: { type: DetailsOfReferenceSchema, required: true, default: () => ({}) },
    detailsOfReference2: { type: DetailsOfReferenceSchema, required: true, default: () => ({}) },
    teleCallGaurantorAttempt1: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallGaurantorAttempt2: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    teleCallGaurantorAttempt3: { type: TeleCallLogSchema, required: true, default: () => ({}) },
    otherRemarks: { type: String, required: true, default: 'NA' },
    teleVerificationResult: { type: Boolean, required: true, default: true },
});

export default mongoose.model<ITeleVerificationForm>('TeleVerificationForm', TeleVerificationFormSchema);